...
- (void)refreshTable {
    ...
    NSString *roles = [NSString stringWithFormat:@"%d,%d,%d", USER_ROLE_PHYSICIAN, USER_ROLE_PHYSICIAN_ASSISTANT, USER_ROLE_NURS];
    [params setObject:roles forKey:@"role"];
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setData:providerArray[indexPath.row]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:@"gotoProviderDetailSegue" sender:self];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"gotoProviderDetailSegue"]) {
        ProviderDetailViewController *vc = [segue destinationViewController];
        ClientInfo *clientInfo = providerArray[currentIndex.row];
        vc.providerInfo = clientInfo;
    }
}
